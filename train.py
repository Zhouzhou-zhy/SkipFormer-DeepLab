...
from SkipFormer_DeepLab.modeling import (
    deeplabv3plus_mvit_unet,
    deeplabv3_xception,
    deeplabv3_resnet50,
)
...
def train_model(
    ...
    experiment = wandb.init(
        project="U-Net", resume="allow", mode="offline", anonymous="must"
    )
            ...
            for batch in train_loader:
                ...
                if division_step > 0:
                    if global_step % division_step == 0:
                        ...
                        mIoU, mf1, iou_per_class, oa = compute_miou(
                            model, val_loader, device, model.n_classes, amp
                        )
...
def get_args():
    ...
    parser.add_argument(
        "--classes", "-c", type=int, default=8, help="Number of classes"
    )
